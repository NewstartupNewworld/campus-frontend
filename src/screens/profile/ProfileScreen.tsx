  ...
  return (
    <View style={lr.row}>
      ...
      <View style={[lr.statusBadge, { backgroundColor: statusColor + '22', borderColor: statusColor + '55' }]}>
        <Text style={[lr.statusText, { color: statusColor }]}>
...
const ss = StyleSheet.create({
  ...
  logoutBtn: {
    marginTop: 12, backgroundColor: Colors.danger + '18',
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.trustCard}>
          ...
          <View style={styles.trustInfo}>
            ...
            <Text style={styles.trustDesc}>
              Based on your sales, ratings, activity, and SOS responses.
            </Text>
            <View style={styles.trustBreakdown}>
              {[
                ...
                <View key={item.label} style={styles.trustItem}>
                  <Text style={[styles.trustItemDot, { color: item.done ? Colors.success : Colors.textDim }]}>
                    {item.done ? '✓' : '○'}
                  </Text>
        ...
        <View style={styles.statsRow}>
          <StatCard icon="🛍️" value={stats.listingsPosted} label="Listed" />
          <StatCard icon="✅" value={stats.successfulSales} label="Sold" />
          <StatCard icon="⚡" value={stats.buzzPosts} label="Posts" />
          <StatCard icon="🚨" value={stats.sosResponses} label="Responses" />
        </View>
          ...
          {activeTab === 'listings' && (
            <>
              ...
              {recentListings.length === 0 && (
                <Text style={styles.empty}>No listings yet. Start selling! 🛍️</Text>
              )}
            </>
          )}
          ...
          {activeTab === 'ratings' && (
            <>
              ...
              {recentRatings.length === 0 && (
                <Text style={styles.empty}>No ratings yet. Complete a sale to get rated!</Text>
              )}
            </>
          )}
